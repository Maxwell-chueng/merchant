<template>
  <div class="carousel">
    ...
    <el-carousel height="460px" arrow="hover" class="mainCarousel">
      <el-carousel-item class="carouselItem" v-if="item.version.length>0" v-for="(item,index) in carouelList" :key="index" height="460px">
...
<style>
.mainCarousel>.el-carousel__container>.el-carousel__arrow--left{
	left: 260px;
}
