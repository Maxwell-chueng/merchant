...
<style>
.checkBox>.el-checkbox__input>.el-checkbox__inner {
  width: 20px;
  height: 20px;
}

.checkBox>.el-checkbox__input>.el-checkbox__inner:hover {
  border-color: #ff6700;
}


.checkBox>.el-checkbox__input>.el-checkbox__inner::after {
  top: 50%;
  left: 50%;
  margin-top: -4px;
  margin-left: -2px;
